    ...
    getCode(code) {
        const responseObj = [
            ...
            },
            {
                code: 403,
                name: "FORBIDDEN",
                description: "You are authenticated but do not have access what you are trying to do",
            },
            {
                code: 404,
                name: "NOT_FOUND",
            ...
            },
            {
                ...
                description: "The request type is not allowed.",
            },
            {
                code: 409,
                name: "CONFLICT",
        ...
        return responseObj.find((res) => res.code === code);
    }
}
